...
let tabs = [[],[59, 51, 63, 95, 64, -38, -21, -6, 16, 44], [23, 29, -12, -23, 40, -4, -40, -60, -98, -52],[10]];
 ...
 */
function Somme(L : number[]) : number | string {
 ...
 */
function Moyenne(L  : number[]) : number |string{
    let somme : number|string;
   if (L.length==0) {
...
let tabs1 = [[10, [59, 51, 63, 95, 64, -38, -21, -6, 16, 44]],[20, [59, 51, 63, 95, 64, -38, -21, -6, 16, 44]],[50, [59, 51, 63, 95, 64, -38, -21, -6, 16, 44]],[50, [23, 29, -12, -23, 40, -4, -40, -60, -98, -52]],[10, []]];
tabs1.forEach(function(element){
    let  min =Number(element[0]) ; //convertir le type number[] en number si non ça met des erreurs de type pour min (number d'un tableau diffère de number)
...
let tabs2 = [[10, 20, [59, 51, 63, 95, 64, -38, -21, -6, 16, 44]],[0, 100, [59, 51, 63, 95, 64, -38, -21, -6, 16, 44]],[10, 20, [23, 29, -12, -23, 40, -4, -40, -60, -98, -52]],[10, 20, []]]
tabs2.forEach(function(element){
    let  min =Number(element[0]) ; //convertir le type number[] en number
    let max = Number(element[1]);
    let notes = (element[2]) as (number | number)[];    //convertir le type (number|number[]) en number: si non : erreur de type pour min (number d'un tableau diffère de number)
